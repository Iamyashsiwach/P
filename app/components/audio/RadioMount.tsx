...
/**
 * Unlocks the radio on the first click or tap anywhere on the page —
 * capture-phase, so a stray stopPropagation elsewhere can't swallow it.
 * Every browser requires a real user gesture before it'll let audio play at
 * all, no exceptions for a fresh visitor — there's no reliable way to skip
 * this click. Rendered only on the home page: music over /book's long-form
