...
// Lucide dropped brand marks, so the three we need live here as inline paths
// rather than pulling in a whole icon library for them.
...
export function XMark(props: BrandIconProps) {
  return (
    <svg {...base(props)}>
