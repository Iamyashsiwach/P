...
export const about = {
  ...
  paragraphs: [
    ...
    'That habit of owning the whole thing is what led me to run Blue Layer Studio for the better part of two years — client sites, start to finish, my own name on the invoice, growing from just me to a team of six working across time zones. These days most of that energy goes into shipping at Accenture.',
